--  local storag = 99000 -- change as you need, be careful with duplicates
--  local position = Position(825, 681, 7)  -- change for temple position
...
--  removeItems:aid(5555) -- change for the tile actionid and be careful with duplicates
--  removeItems:register()