...
ZombieEvent = {
	...
	fromPos = Position(998, 641, 7),
	toPos = Position(1052, 673, 7),
	centerPos = Position(1024, 657, 7),

	tpId = 1949,
	tpPos = Position(825, 687, 7),
	tpTime = 5, -- minutes

	exitPos = Position(825, 681, 7),

	-- Calendary
	days = {"Monday", "Tuesday", "Wednesday", "Thursday", "Friday"},
	hours = {"12:10", "19:10", "22:10", "23:10"},
	weekendDays = {"Saturday", "Sunday"},
	weekendHours = {"04:15", "07:15", "10:15", "13:15", "16:15", "19:15", "22:15", "01:15", "23:14"},
...
for _, hour in ipairs(ZombieEvent.weekendHours) do
	local initEvent = GlobalEvent(format("ZombieEventInit%s", hour))
