...
void LuaEnums::initConditionParamEnums(lua_State* L) {
	...
	registerEnum(L, CONDITION_PARAM_HEALTHPERCENTGAIN);
	registerEnum(L, CONDITION_PARAM_HEALTHPERCENTTICKS);
	registerEnum(L, CONDITION_PARAM_MANAGAIN);
	registerEnum(L, CONDITION_PARAM_MANAPERCENTGAIN);
	registerEnum(L, CONDITION_PARAM_MANATICKS);
	registerEnum(L, CONDITION_PARAM_MANAPERCENTTICKS);
